...
namespace KartvizitPro.ViewModel
{
    public static class CustomMessageBoxViewModel
    {
        ...
        public static MessageBoxResult ShowDialog(string messageBoxText, string caption = null, MessageBoxButton? button = null, PackIconKind? icon = null)
        {
            return ShowDialogCore(messageBoxText, caption, button ?? _defaultButton, icon);
        }

        private static MessageBoxResult ShowDialogCore(string messageBoxText, string caption, MessageBoxButton? button, PackIconKind? icon)
        {
            // Setup new messagebox
            var messageBox = new CustomMessageBox(messageBoxText, caption, button ?? _defaultButton, icon);
